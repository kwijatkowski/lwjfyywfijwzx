...
namespace Exchange.BitBayTests
{
    ...
    public class FeesTests
    {
        ...
        [TestCase(OperationCostCalculator.OPERATION_TYPE.maker , 125000, ExpectedResult = 0.0022)]
        [TestCase(OperationCostCalculator.OPERATION_TYPE.taker , 75000, ExpectedResult = 0.0033)]
        [TestCase(OperationCostCalculator.OPERATION_TYPE.maker , -100, ExpectedResult = 0.003)]
        [TestCase(OperationCostCalculator.OPERATION_TYPE.taker , 0, ExpectedResult = 0.0043)]
        public decimal TransactionFees(OperationCostCalculator.OPERATION_TYPE operationType, decimal volume)
        {
